          ...
          <div className="nk-block nk-block-features">
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-4">
                ...
                >
                  <div className="feature-icon feature-icon-xl">
                    <img src="images/icons/icon-h-nobg.png" alt="feature" />
                  </div>
              ...
              <div className="col-lg-4 col-md-4">
                ...
                >
                  <div className="feature-icon feature-icon-xl">
                    <img src="images/icons/icon-i-nobg.png" alt="feature" />
                  </div>
                  <div className="feature-text feature-text-s8">
                    <h4 className="title title-md mb-1 title-thin title-s7">
                      Highly Scalable
              ...
              <div className="col-lg-4 col-md-4">
                ...
                >
                  <div className="feature-icon feature-icon-xl">
                    <img src="images/icons/icon-j-nobg.png" alt="feature" />
                  </div>
                  <div className="feature-text feature-text-s8">
                    <h4 className="title title-md mb-1 title-thin title-s7">
                      Reliable &amp; Low Cost
            ...
            <div className="nk-block boxed boxed-xl bg-white round-lg">
              <div className="row">
                ...
                >
                  ...
                  <p className="lead lead-regular lead-s2">
                    We recommend that you store all digital assets in a secure
                    wallet
                  </p>
                </div>
                {/* Section Head @s */}
                  ...
                  >
                    ...
                    <div className="feature-text">
                      ...
                      <ul className="list list-check ml-0">
                        ...
                        <li>Generate stable returns on your crypto assets</li>
                ...
                <div className="col-lg-5">
                  ...
                  >
                    ...
                    <div className="feature-text">
                      ...
                      <ul className="list list-check ml-0">
                        <li>
                          Take full control of your assets and private keys for
                          maximum safety
                        </li>
                        <li>
                          Easily import your mnemonic seeds from other wallets
                          you may own
                        </li>
                        <li>EOS voting</li>
                      </ul>
                ...
                <div className="col-lg-4 col-mb-9">
                  ...
                  >
                    ...
                    <div className="feature-text">
                      ...
                      <p>
                        All the smart contact are lorem Ipsum is simply dummy.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-6 col-mb-9">
                <div className="nk-block-text">
                  ...
                  <p
                    ...
                    data-delay=".2"
                  >
                    Enim id excepteur nulla est nisi voluptate nisi aliquip esse
                    irure duis. Sint enim tempor pariatur consequat non laboris
                    sint elit do. Ex occaecat et sunt esse consectetur magna
                    excepteur deserunt labore minim et laborum dolor. Quis
                    fugiat irure cillum proident nulla duis aliqua. In
                    exercitation esse aliquip irure ipsum incididunt aliquip
                    labore consectetur non ullamco aute. Quis consequat irure
                    qui ullamco et sint excepteur reprehenderit. Laboris
                    proident deserunt pariatur incididunt laboris est occaecat
              ...
              <div className="col-lg-6 col-mb-9">
                <div className="nk-block-text">
                  ...
                  <p
                    ...
                    data-delay=".3"
                  >
                    Commodo labore eu incididunt adipisicing do commodo duis
                    excepteur laborum. Occaecat aliquip sint proident amet sit
                    consequat voluptate. Pariatur Lorem fugiat proident occaecat
                    aliquip eu do incididunt ullamco. Dolor voluptate occaecat
                    deserunt ea. Est proident duis enim aute proident occaecat
                    minim elit.
                  </p>
                </div>
              </div>
